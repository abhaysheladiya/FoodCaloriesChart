...
<head>
    ...
    <link rel="icon" href="#">
    <title>Food calories chart</title>
...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo2.png" alt="" width="18%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg2.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Food Calories Chart</h1>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">Order food and View Calories of the food</p>
            </div>
            <div class="row">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>choose restaurant according to your choice.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p>Choose dish and view calories of the dish.</p>
                        </div>
                    </div>
